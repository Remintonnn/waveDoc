...
import PageGen.waveDoc_support as waveDoc_support
...
(欄位只有在你取消聚焦時會被儲存到設定/回復預設)''')
        ...
        self.WaveInfoAutoUpdateToggle.configure(command=waveDoc_support.SetWaveInfoAutoRefresh)
        ...
        self.WaveRequestFinishMsgAutoResetToggle.configure(command=waveDoc_support.SetWaveRequestFinishMsgAutoReset)
        ...
        self.RefreshWaveInfoButton.configure(command=waveDoc_support.RefreshWaveInfo)
        ...
        self.BuyerIDCopyButton.configure(command=waveDoc_support.BuyerIDCopy)
        ...
        self.BuyerIDCopyFormatedButton.configure(command=waveDoc_support.BuyerIDCopyFormated)
